 ...
 *
 * This is a LOCAL DEMO of the functionality being added to @supabase/supabase-js/cors
 * Once the SDK is updated, you can import directly from '@supabase/supabase-js/cors'
 *
 * @example Basic usage
 * ```typescript
